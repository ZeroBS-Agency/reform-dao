...
function setupClickListener() {
  ...
  alphaPicOpen.addEventListener("click", function () {
    ...
    // Set positions for beta and gamma pictures
    document.getElementById("beta-pic-a").style.cssText +=
      "left: 2.5rem; bottom: 2.5rem;";
    document.getElementById("beta-pic-b").style.cssText +=
      "left: 8.75rem; bottom: 2.5rem;";
    ...
    document.getElementById("gamma-pic-c").style.cssText +=
      "left: 22.5rem; bottom: 2.5rem;";
  });
}
