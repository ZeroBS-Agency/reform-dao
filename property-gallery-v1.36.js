if (window.innerWidth >= 1024) {
  ...
  function setupClickListener() {
    ...
    alphaPicOpen.addEventListener("click", function () {
      ...
      alphaPic.style.top = "0rem";
      alphaPic.style.left = "0rem";
      alphaPic.style.zIndex = "2";
      ...
      document.getElementById(
        "gamma-pic-c"
      ).style.cssText += `left: 27.5rem; bottom: 2.5rem;`; // Assume gamma-pic-c also uses bottom positioning
  ...
  function setupBetaPicAOpenClickListener() {
    ...
    betaPicAOpen.addEventListener("click", function () {
      ...
      document.getElementById(
        "alpha-pic"
      ).style.cssText += `left: 2.5rem; top: ${topPositionPx}; z-index: 4;`;
      document.getElementById(
        "beta-pic-b"
      ).style.cssText += `left: 8.75rem; bottom: 2.5rem;`; // Beta-pic-b uses bottom positioning
      document.getElementById(
  ...
  function setupBetaPicBOpenClickListener() {
    ...
    betaPicBOpen.addEventListener("click", function () {
      ...
      document.getElementById(
        "beta-pic-a"
      ).style.cssText += `left: 8.75rem; top: ${topPositionPx}; z-index: 4;`;
      document.getElementById(
        "gamma-pic-a"
      ).style.cssText += `left: 15rem; top: ${topPositionPx};`;
      document.getElementById(
  ...
  function setupGammaPicAOpenClickListener() {
    ...
    gammaPicAOpen.addEventListener("click", function () {
      ...
      document.getElementById(
        "beta-pic-a"
      ).style.cssText += `left: 8.75rem; top: ${topPositionPx}; z-index: 4;`; // Beta-pic-b uses bottom positioning
      document.getElementById(
        "beta-pic-b"
      ).style.cssText += `left: 15rem; bottom: 2.5rem; z-index: 4;`;
      document.getElementById(
        "gamma-pic-b"
      ).style.cssText += `left: 21.25rem; top: ${topPositionPx};`;
      document.getElementById(
  ...
  function setupGammaPicBOpenClickListener() {
    ...
    gammaPicBOpen.addEventListener("click", function () {
      ...
      document.getElementById(
        "gamma-pic-a"
      ).style.cssText += `left: 21.25rem; top: ${topPositionPx}; z-index: 4;`;
      document.getElementById(
        "gamma-pic-c"
      ).style.cssText += `left: 27.5rem; bottom: 2.5rem;`; // Assume gamma-pic-c also uses bottom positioning
  ...
  function setupGammaPicCOpenClickListener() {
    ...
    gammaPicCOpen.addEventListener("click", function () {
      ...
      document.getElementById(
        "gamma-pic-b"
      ).style.cssText += `left: 27.5rem; top: ${topPositionPx}; z-index: 4;`; // Assume gamma-pic-c also uses bottom positioning
  ...
  function setupClickListenerTour() {
    var tourOpen = document.getElementById("alpha-pic-open");
    tourOpen.addEventListener("click", function () {
      tourOpen.style.display = "none";
      var tourClose = document.getElementById("alpha-pic-close");
      tourClose.style.display = "flex";
      var tourFrame = document.getElementById("alpha-pic");
      tourFrame.style.width = "100%";
      tourFrame.style.height = "100%";
      tourFrame.style.top = "0rem";
      tourFrame.style.left = "0rem";
      tourFrame.style.zIndex = "2";
