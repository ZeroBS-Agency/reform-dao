...
function setupCloseClickListener() {
  ...
  alphaPicClose.addEventListener("click", function () {
    ...
    // Reset positions for beta and gamma pictures as specified
    var totalLeftBeta = calculateTotalLeft();
    var totalLeftGamma = totalLeftForGamma();

    // Beta Pictures
    var betaPicA = document.getElementById("beta-pic-a");
    betaPicA.style.cssText = `left: ${totalLeftBeta}; top: 0rem; width: 14rem; height: 18.625rem;`;

    var betaPicB = document.getElementById("beta-pic-b");
    betaPicB.style.cssText = `left: ${totalLeftBeta}; bottom: 0rem; width: 14rem; height: 18.625rem;`;

    // Gamma Pictures
    var gammaPicA = document.getElementById("gamma-pic-a");
    gammaPicA.style.cssText = `left: ${totalLeftGamma}; top: 0rem; width: 12rem; height: 12rem;`;

    var gammaPicB = document.getElementById("gamma-pic-b");
    gammaPicB.style.cssText = `left: ${totalLeftGamma}; top: 13.25rem; width: 12rem; height: 12rem;`;

    var gammaPicC = document.getElementById("gamma-pic-c");
    gammaPicC.style.cssText = `left: ${totalLeftGamma}; bottom: 0rem; width: 12rem; height: 12rem;`;
  });
}
