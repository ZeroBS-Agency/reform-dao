...
function setupClickListener() {
  ...
  alphaPicOpen.addEventListener("click", function () {
    ...
    document.getElementById(
      "gamma-pic-a"
    ).style.cssText += `left: 10rem; top: ${topPositionPx};`;
    document.getElementById(
      "gamma-pic-b"
    ).style.cssText += `left: 16.25rem; top: ${topPositionPx};`;
    document.getElementById(
      "gamma-pic-c"
    ).style.cssText += `left: 22.5rem; bottom: 2.5rem;`; // Assume gamma-pic-c also uses bottom positioning
  });
}
